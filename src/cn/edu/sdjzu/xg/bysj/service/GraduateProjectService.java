...
public final class GraduateProjectService {
	...
	//更新一个课题
	public void updateGraduateProject(GraduateProject project) throws SQLException, ClassNotFoundException {
		graduateProjectDao.update(project);
	}
	//更新一个课题
	public void update(GraduateProject project) throws SQLException, ClassNotFoundException {
		graduateProjectDao.update(project);
	}
	//获得id对应的课题
